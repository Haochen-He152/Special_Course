...
class RewardsCfg:
    ...
    gripper_closed_near_object = RewTerm(
        ...
        params={"near_threshold": 0.12, "std": 0.08, "open_width": 0.04},
        weight=1.0,
    )
...
class CurriculumCfg:
    ...
    action_rate = CurrTerm(
        func=mdp.modify_reward_weight, params={"term_name": "action_rate", "weight": -1e-1, "num_steps": 0}
    )

    joint_vel = CurrTerm(
        func=mdp.modify_reward_weight, params={"term_name": "joint_vel", "weight": -1e-1, "num_steps": 0}
    )
