...
gym.register(
    id="Isaac-Lift-Yaw-Cube-Franka-v0",
...
gym.register(
    id="Isaac-Lift-Yaw-Cube-Franka-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Yaw-Cube-Franka-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Yaw-Teddy-Bear-Franka-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Yaw-Cube-Franka-IK-Rel-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
