...
Run from an Isaac Lab checkout, for example:
    ...
    ./isaaclab.sh -p github/Special_Course/lift_xy_yaw/tools/record_six_envs_initial.py --headless
"""
...
parser.add_argument(
    "--output-dir",
    type=str,
    default="github/Special_Course/lift_xy_yaw/outputs/six_envs_initial_video",
