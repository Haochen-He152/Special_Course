...
gym.register(
    id="Isaac-Lift-Simple-Franka-v0",
...
gym.register(
    id="Isaac-Lift-Simple-Franka-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Simple-Franka-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Simple-Teddy-Bear-Franka-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Simple-Franka-IK-Rel-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
