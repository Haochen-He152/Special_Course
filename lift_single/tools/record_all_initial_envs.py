...
"""Record short headless videos for all lift_single initial object scenes.

Run from an Isaac Lab checkout, for example:

    ./isaaclab.sh -p github/Special_Course/lift_single/tools/record_all_initial_envs.py --headless
...
parser = argparse.ArgumentParser(description="Record initial videos for all lift_single objects.")
...
parser.add_argument(
    "--output-dir",
    type=str,
    default="github/Special_Course/lift_single/outputs/initial_env_videos",
...
import lift_single.config.franka  # noqa: F401  # registers the lift_single Franka tasks
from lift_single.config.franka.joint_pos_env_cfg import (
...
TASKS = {
    "SugarBox": ("Isaac-Lift-Single-SugarBox-Franka-Play-v0", FrankaSugarBoxLiftEnvCfg_PLAY, "sugar_box"),
    "TomatoSoupCan": (
        "Isaac-Lift-Single-TomatoSoupCan-Franka-Play-v0",
        FrankaTomatoSoupCanLiftEnvCfg_PLAY,
        "tomato_soup_can",
    ),
    "MustardBottle": (
        "Isaac-Lift-Single-MustardBottle-Franka-Play-v0",
        FrankaMustardBottleLiftEnvCfg_PLAY,
        "mustard_bottle",
    ),
    "WhiteCube": ("Isaac-Lift-Single-WhiteCube-Franka-Play-v0", FrankaWhiteCubeLiftEnvCfg_PLAY, "white_cube"),
    "BlackCube": ("Isaac-Lift-Single-BlackCube-Franka-Play-v0", FrankaBlackCubeLiftEnvCfg_PLAY, "black_cube"),
    "SmallTomatoSoupCan": (
        "Isaac-Lift-Single-SmallTomatoSoupCan-Franka-Play-v0",
        FrankaSmallTomatoSoupCanLiftEnvCfg_PLAY,
...
def _record_one_object(object_task_name: str, output_root: Path) -> None:
    ...
    video_kwargs = {
        ...
        "name_prefix": f"lift_single_{object_key}_initial_env",
        "disable_logger": True,
    }
